...
module.exports = {
    ...
    getSenderById: (uId) => db.load(`select u.account_num, b.id, b.surplus, b.type, u.name, b.surplus, u.email from user_info u join banking_account b on u.id = b.owner_id where u.id = '${uId}'`),

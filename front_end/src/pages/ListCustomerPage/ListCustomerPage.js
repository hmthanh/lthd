...
class ListCustomerPage extends Component {
  ...
  componentDidMount() {
    ...
    this.props.getAllCustomer(uid, accessToken);
  }
              ...
              <Card className="p-6">
                <div className="card-block" style={{padding: "20px 40px"}}>
                  ...
                  <Table>
                    ...
                    <tbody>
                    {
                      this.props.AllCustomer.data.response && this.props.AllCustomer.data.response.map((item, index) => (
                              <tr key={index}>
...
const mapDispatchToProps = dispatch => ({
  getAllCustomer: (id, accessToken) => dispatch(getAllCustomer(id, accessToken)),
...
export default connect(mapStateToProps, mapDispatchToProps)(ListCustomerPage);

import {FORGET_PASSWORD_FAILED, FORGET_PASSWORD_LOADING, FORGET_PASSWORD_SUCCESS} from '../actions/actionType'
  ...
  return (dispatch) => {
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        console.log("sdlksjdlaksfjlsk jdkfj laksjlksadjl ksdjlk2");

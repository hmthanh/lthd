import { HISTORY_SUCCESS, HISTORY_LOADING, HISTORY_FAILED } from '../actions/actionType'
...
export const getAllHistory = (id) => (dispatch) => {
  ...
  return fetchFrom(UrlApi + '/api/accounts/id', 'POST', { id })
    .then(response => {
      response = { val: [
        {id: 1, day:new Date() , type: 'Nội bộ', send:'thanh', recieve:'tam', money:120000, excess:100000},
        {id: 2, day:new Date() , type: 'ngoaij bang', send:'sdf', recieve:'tam', money:990000, excess:1200000},
